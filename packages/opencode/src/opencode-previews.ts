...
export function buildOpenCodeMcpEntry(options: OpenCodePreviewOptions): OpenCodeMcpEntry {
  const petArgs = options.petId === undefined ? [] : ["--pet", validateNoelCrewPetArg(options.petId)];
